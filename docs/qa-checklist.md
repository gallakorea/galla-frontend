...
마지막 갱신: 2026-08-30 (7차 — 전투·숏판·제보·갈비스·게스트 실측. 로그인 기록 기록기 부재 발견·수정, SPA 재방문 초기화 결함 발견·수정)
...
| 롱판(가로) 업로드 | ❌ | ❌ | ❌ |
| 예측 마켓 생성 | ⛔ 잠김 | ⛔ | ⛔ |
| 제보하기 (+100 GP) | ✅ | ❌ | ✅ |  <!-- tips 생성 + point_ledger tip:submit, 하루 3회 상한 서버강제 -->
| 제보 — 미디어 첨부 | ❌ | ❌ | ❌ |
| 임시저장·복원 | 🔶 광장만 | ✅ | ❌ |
| 수정·삭제(owner-actions) | ❌ | ❌ | ❌ |
...
`grep -rl "사업자등록\|통신판매\|대표자\|청소년보호\|개인정보관리책임" *.html` → **전부 0건**

| 항목 | 근거 | 상태 |
|---|---|---|
| **사업자등록번호·상호·대표자명** | 전자상거래법 §10 표시의무 | ❌ 어디에도 없음 |
| **통신판매업 신고번호** | 결제 선행 요건 | ❌ (신고 자체가 미완) |
| **사업장 주소·연락처·이메일** | 표시의무 | ❌ |
| **호스팅 제공자 표시** | 표시의무 | ❌ |
| **청소년보호책임자** | 청소년보호법 | ❌ |
...
| 앱스토어 개인정보 라벨(nutrition) | 심사 필수 | ❌ |
| 연령등급·심사 메모·테스트 계정 제공 | 심사 필수 | ❌ |
...
| 항목 | 상태 |
|---|---|
| **AI 사업자 4곳 위탁·국외이전 고지** | ❌ 방침에 한 번도 안 나옴 |
| 이전 국가·시점·방법·항목 명시 | ❌ |
| 대화 내용의 보유기간·파기 | ❌ |
