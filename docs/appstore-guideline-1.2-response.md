...
- **연령등급: 정직하게 15+(한국)/16+(글로벌)** — 애플 공식 정의상 18+ 유발 요소(노골적 성적 콘텐츠·사실적 폭력)가 갈라엔 없음. UGC·소셜·익명은 18+ 유발 안 함(주도 15+가 실증).
...
GALLA is a civic discussion community and does not contain the explicit sexual content or graphic violence that Apple's guidelines associate with an 18+ rating; its content is appropriately rated 15+/16+ (mature/suggestive themes + user-generated content). A step-by-step test guide is below.
...
- [ ] App Store Connect 연령설문은 현재 15+ 그대로 유지(성적콘텐츠·폭력 '없음', 성숙테마 반영)
