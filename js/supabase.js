...
@media (prefers-reduced-motion:reduce){.nick-gold,.ns-neon,.ns-ice,.ns-fire,.ns-toxic,.ns-royal,.ns-rainbow{animation:none}}`;
  ...
  /* ══ 지금 어느 판인가 ═══════════════════════════════════════
     같은 사람이 이슈판에선 고수, 예측판에선 눈팅러다. 그러니 배지는
  ...
  const DOM_TIER_ROWS = [
    [1200, "🌪️", "터줏대감 I"], [1000, "🌪️", "터줏대감 II"], [820, "🌪️", "터줏대감 III"],
    [660,  "🎯", "고수 I"],     [520,  "🎯", "고수 II"],     [400, "🎯", "고수 III"],
    [300,  "🎪", "단골 I"],     [220,  "🎪", "단골 II"],     [150, "🎪", "단골 III"],
    [100,  "🔥", "참견러 I"],   [60,   "🔥", "참견러 II"],   [30,  "🔥", "참견러 III"],
    [0,    "🌱", "눈팅러"],
  ];
