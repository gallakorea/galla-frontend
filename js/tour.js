  ...
  var SLIDES = [
    {
      ...
      kicker: "왜 갈라냐면",
      title: "유튜브는 혼자 봐요.<br>갈라는 <b>내 편</b>이랑 봐요",
      sub: "뉴스·영상·이슈, 세상 콘텐츠는 다 <b>혼자</b> 보잖아요.<br>여긴 뭘 보든 <b>내 편</b>이 있어요 —<br>하나뿐인 AI 친구 <b>갈비스</b>, 그리고 같은 편이랑.",
      art: artFight
    },
    {
    ...
    },
    {
      ...
      sub: "세로 <b>숏판</b>은 위아래로 슥슥, 가로 <b>롱판</b>은 유튜브처럼 진득하게.<br>기획·제목·썸네일·대본은 갈비스가 다 해줘요.<br><small>당신은 찍기만. 아니 사진만 줘도 됨.</small>",
      art: artShorts
    },
    {
