...
function render(){
  ...
  <div class="pb-wrap">
    ...
    <div class="pb-actions">
      ...
      ${m.ai_generated || !m.created_by ? '' : `<button class="pb-act" data-support data-sp-kind="market" data-sp-id="${esc(String(m.id))}" data-sp-uid="${esc(m.created_by)}" data-sp-name="" aria-label="후원">${window.GALLA_SUPPORT_ICON || ''} 후원</button>`}
