...
/* ============ GP 원장 ============ */
/* ⚠️ wallet.js 의 GP_LABELS 와 같은 목록을 유지한다 — 어긋나 있어 활동 보상(act_*)·이슈 승리·뽑기·환영 보너스가
   「act_market」 같은 내부 코드로 보였다(2026-09-10 QA). 모르는 사유도 코드는 안 보인다. */
const REASONS = [
  [/^predict:bet$/,   ['🎯','예측 참여']],
  ...
  [/^shop:/,          ['🛒','상점 구매']],
  [/^charge:/,        ['💳','GP 충전']],
  [/^support:|^faction|^push/, ['⚔️','진영 밀어주기']],
  [/^gacha_win/,      ['🎁','뽑기 대성공']],
  [/^gacha/,          ['🎁','갈라 뽑기']],
  [/^tier_bonus:/,    ['⭐','등급 보너스']],
  [/^issue_win/,      ['🏅','이슈 승리']],
  [/^battle:/,        ['⚔️','댓글 배틀']],
  [/^duel_stake/,     ['🥊','일기토 참여']],
  [/^duel_refund/,    ['↩️','일기토 환불']],
  [/^duel_win/,       ['🏆','일기토 승리']],
  [/^duel/,           ['🥊','일기토']],
  [/^act_issue$/,     ['📝','이슈 발의']],
  [/^act_market$/,    ['🎯','예측 문제 만들기']],
  [/^act_comment$/,   ['💬','댓글 활동']],
  [/^act_vote$/,      ['🗳️','투표 참여']],
  [/^act_follow$/,    ['👥','팔로우']],
  [/^welcome/,        ['🎉','가입 환영']],
  [/^tour_bonus$/,    ['🎉','투어 완주 보너스']],
  [/^referral:/,      ['🎁','친구 초대']],
  [/^ai_creation:refund/, ['↩️','AI 창작 환불']],
  [/^ai_creation/,    ['🎨','AI 창작']],
  [/^ai_sticker/,     ['🩹','나만의 이모티콘']],
  [/^ghost_pass/,     ['👻','유령권']],
  [/^title:/,         ['🏷️','칭호']],
