import { loadAiArguments } from "./issue-argument.js?v=0717f";
import { loadAiNews } from "./issue-news.js?v=0717f";
import { loadStats } from "./issue.stats.js?v=0717f";
import { initCommentSystem } from "./issue.comments.js?v=0717f";
