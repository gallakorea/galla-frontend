import { loadAiArguments } from "./issue-argument.js?v=0718n";
import { loadAiNews } from "./issue-news.js?v=0718n";
import { loadStats } from "./issue.stats.js?v=0718n";
import { initCommentSystem } from "./issue.comments.js?v=0718n";
