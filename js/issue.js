import { loadAiArguments } from "./issue-argument.js?v=0717n";
import { loadAiNews } from "./issue-news.js?v=0717n";
import { loadStats } from "./issue.stats.js?v=0717n";
import { initCommentSystem } from "./issue.comments.js?v=0717n";
