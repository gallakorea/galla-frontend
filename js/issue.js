import { loadAiArguments } from "./issue-argument.js?v=0718f";
import { loadAiNews } from "./issue-news.js?v=0718f";
import { loadStats } from "./issue.stats.js?v=0718f";
import { initCommentSystem } from "./issue.comments.js?v=0718f";
