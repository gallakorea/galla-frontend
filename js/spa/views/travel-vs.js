/* ═══════════════════════════════════════════════════════════════
 * GALLA SPA 뷰 어댑터 — travel-vs (어디 갈래 16강, 스택 뷰)
 *
 * 로직은 js/travel-vs.js 가 전부 갖고 있고 여기서는 그 스크립트를 1회 주입한 뒤
 * window.GALLA_PAGE_TRAVEL_VS.mount(root, params) 에 위임만 한다(travel-place 와 같은 계약).
...
export async function mount(root, params) {
  ...
  const api = window.GALLA_PAGE_TRAVEL_VS;
