/* =========================================================
   ...
   · 지도는 아직 없다. 다만 **타일 문제는 2026-09-04 에 풀렸다** — 맛집이 네이티브 네이버 SDK
     (packages/naver-map)로 돌고 있고 앱에서 OSM 타일 요청 0건임을 실측했다.
     travel_map RPC 도 이미 있으니 붙이려면 js/food.js 의 지도 백엔드 구조를 그대로 쓰면 된다.
   ========================================================= */
(function () {
