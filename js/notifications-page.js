...
(function () {
  ...
  const TYPE = {
    ...
    /* 26.9.19 알림 QA — 여기 없던 타입은 전부 「기타·종」으로 떨어졌다 */
    duel_challenge:  { ic: "swords",  cls: "t-duel",    key: "battle" },
    duel_live:       { ic: "swords",  cls: "t-duel",    key: "battle" },
    duel_voting:     { ic: "vote",    cls: "t-duel",    key: "battle" },
    duel_watch:      { ic: "swords",  cls: "t-duel",    key: "battle" },
    duel_decline:    { ic: "swords",  cls: "t-duel",    key: "battle" },
    duel_forfeit:    { ic: "swords",  cls: "t-duel",    key: "battle" },
    duel_extend:     { ic: "swords",  cls: "t-duel",    key: "battle" },
