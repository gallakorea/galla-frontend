...
document.addEventListener("DOMContentLoaded", () => {
...

  {
    ...
    const overlayOpen = () => document.querySelector(
      ...
      "#pager-call.on, #pager-book.on, #dm-call.on, #nav-jog, #lv-stage, .fd-map.open, " +
...
(function () {
  ...
  const overlayOpen = () => document.querySelector(
    "#dm-root.open:not(.page), .wh-sheet.open, .shop-sheet.open, .noti-drawer.open, " +
    "#mpQuickView.open, #createModal:not([hidden]), #plaza-write-modal:not(.hidden), #nav-jog, .fd-map.open"
  ) || document.body.classList.contains("dm-detail");
