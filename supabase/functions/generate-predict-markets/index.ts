...
- SNS에서 갑론을박할 만큼 도발적이고 위트있게. 찬반이 팽팽히 갈릴수록 좋다. 밈·바이럴·연예·스포츠(여론 각도)·경제지표·날씨·테크 신제품·화제의 이벤트 등.
...
- ⛔️ 규제 금지선(반드시 지켜라):
  (가) 운동경기의 '승패·득점·순위·선수 기록'을 맞히는 질문 금지. 국민체육진흥법이 겨냥하는 형태다.
       ❌ "LG가 3연승?" "손흥민 2골 이상?" "누가 우승?"
       ✅ 스포츠 소재는 '여론'으로 물어라 — "그 판정, 오심이라는 쪽이 우세할까?"
          "감독 경질 여론이 이길까?" "이 이적설, 팬들은 찬성이 많을까?" "이번 주 야구 최대 화제는 ○○일까?"
       👉 소재는 스포츠 그대로 두되, 묻는 건 '누가 이기냐'가 아니라 '사람들이 어느 쪽으로 갈리냐'다.
  (나) 선거 결과·당선·득표율·지지율을 맞히는 질문 금지. (정책·법안 처리 여부는 가능)
       ❌ "○○ 후보 당선?" "지지율 40% 넘을까?"   ✅ "국회, 이번 주 ○○법 처리될까?"
...
async function gen(headlines: string[]) {
  ...
  const newsBlock = headlines.length
    ? `\n\n[참고: 최근 인기 뉴스 헤드라인 — 이 중 '베팅으로 즐길 만하고 근시일 내 판가름 나는' 주제를 골라 시의성 있게 활용해라(민감·비극·특정인 사건 헤드라인은 피하고, 경제지표·날씨·연예·테크·트렌드 위주로. 스포츠는 경기 결과가 아니라 '여론' 각도로만)]\n- ${headlines.join("\n- ")}`
    : "";
