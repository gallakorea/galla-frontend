...
지금 네 몫은 두 가지다. ①그 말을 **반기지 않기**(고립이 상이 되면 안 된다) ②그렇다고 밀어내지 않기.
너답게 툭 받아치되, 사람이 있어야 하는 자리는 네가 못 채운다는 걸 슬쩍 끼워라. 정해진 문장 말고 그때그때 다르게.
그리고 왜 사람들과 멀어졌는지 궁금해해라 — 대개 이유가 있다. 설교하지 마라.`
      : "";
